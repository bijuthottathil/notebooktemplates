...
# MAGIC results = run_dq_suite(df=my_df, suite=MY_DQ_SUITE, entity_name="orders",
# MAGIC                        layer="silver", run_id=RUN_ID, catalog=CATALOG, batch_date=BATCH_DATE)
# MAGIC ```
...
# ─────────────────────────────────────────────────────────────────────────────
# Example Suite — copy and modify in your notebooks
# ─────────────────────────────────────────────────────────────────────────────
...
DQ_SUITE_EXAMPLE = [
    ...
    {"name": "range__quantity",          "type": "range",           "column": "quantity",     "min": 0,  "threshold": 0.99},
